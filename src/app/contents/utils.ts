...
export const projects: Project[] = [
  ...
  },
  {
    title: "쏘핏 공식 홈페이지",
    description:
      "쏘핏에 대한 소개가 담긴 랜딩페이지 형식의 공식 홈페이지 서비스에 대한 사용자, 입점 판매자를 위한 페이지가 나뉘어서 안내",
    image: sofitWeb,
    roles: [
  ...
  },
  {
    ...
    description:
      "사건발생시 현장 CCTV를 확인하기 위한 시스템 기존 PC환경을 통해 제공되던 서비스를 모바일에 웹앱 형태로 추가 제공하기 위해 작업",
    image: sofitWeb,
    notice:
      "내부 전용 서비스입니다. 보안상의 이유로 직접 확인이 불가한 점 양해 부탁드립니다.",
    roles: [
  ...
  {
    title: "경주 통합플랫폼 문화재관리 및 수문관리 시스템",
    description:
